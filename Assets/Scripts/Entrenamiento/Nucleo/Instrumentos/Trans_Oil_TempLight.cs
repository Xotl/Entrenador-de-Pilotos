...
{
    class Trans_Oil_TempLight : Instrumento
    {
        public Trans_Oil_TempLight()
            : base(NombresDeInstrumentos.Trans_Oil_Temp_Light, TiposDeIntrumentos.Indicador_Luminoso)
        {
        }
        ...
        // estos valores aparecen el PDF pero no me cudran con los del instrumento 
    }
}
