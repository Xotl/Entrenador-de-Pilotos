...
namespace Interfaz.Utilities
{
    ...
    public class AreaDeTexto : MonoBehaviour
    {
        /// <summary>
        ...
        private void DibujarCajaEditable()
        {
            ...
            this.Texto = GUI.TextField(new Rect(posicion.x, Screen.height - posicion.y, anchoPx, altoPx), this.Texto, this.MaxLength, this.Estilo);
        }
